...
public class GammelGeldActivity extends AppCompatActivity {
    ...
    private void generateValues() {
        ...
        i++;
        randomNumbersTab[0][i] = (float) 124;
        i++;
        ...
        i++;
        randomNumbersTab[0][i] = (float) 118;
        i++;
        randomNumbersTab[0][i] = (float) 119;
        i++;
    ...
    private void generateData() {
        ...
        if (hasAxes) {
            ...
            axisX.setFormatter(new SimpleAxisValueFormatter().setPrependedText("test".toCharArray()));//.setAppendedText("km".toCharArray()));
